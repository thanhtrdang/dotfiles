...
export ZSH="/Users/thanhdang/.oh-my-zsh"
...
# Space management (yabai, skhd)
# Config keyboard shortcut for switch space in System Prefs
function switch_desktop() {
    typeset -A desktop2keystroke

    desktop2keystroke[1]="y"
    desktop2keystroke[2]="u"
    desktop2keystroke[3]="i"
    desktop2keystroke[4]="o"

    desktop=$1
    keystroke=${desktop2keystroke[$desktop]}
